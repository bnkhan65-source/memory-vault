...
export default function GuidePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 px-4 py-8 max-w-2xl mx-auto">

      {/* Back button */}
      <button
        onClick={() => router.push("/")}
        className="flex items-center gap-2 text-sm text-slate-400 hover:text-violet-400 transition-colors mb-6"
      >
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl font-bold text-slate-100 mb-1">Stash</h1>
        <p className="text-violet-400 font-medium">User Guide</p>
        <p className="text-slate-400 text-sm mt-2">Your memories, all in one place</p>
      </div>

      {/* What is Stash */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">What is Stash?</h2>
      ...
      {/* Getting Started */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">1. Getting Started</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-3">
          Stash is a web app — no App Store download required. Open your browser and go to:
        </p>
        <div className="bg-slate-900 border border-violet-500/30 rounded-xl p-3 text-center mb-4">
          <span className="text-violet-400 font-mono text-sm font-medium">usestash.vercel.app</span>
        </div>
        <p className="text-slate-300 text-sm leading-relaxed mb-3">
      ...
      {/* Best Browser */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">2. Best Browser for Your Device</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-3">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden text-sm">
          <div className="grid grid-cols-4 bg-slate-800 text-slate-400 text-xs font-medium px-4 py-2">
            <span>Device</span>
          ...
          {[
            ...
            <div key={i} className="grid grid-cols-4 px-4 py-2 border-t border-slate-800 text-slate-300">
              <span>{device}</span>
              <span>{browser}</span>
              <span>{voice}</span>
              <span>{install}</span>
        ...
        <p className="text-slate-500 text-xs mt-2 px-1">💡 Safari on iPhone gives the smoothest experience — voice search, install-as-app, and all features work perfectly out of the box.</p>
      </section>

      {/* Install on Phone */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">3. Install Stash on Your Phone</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-4">
        ...
        <div className="space-y-4">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-4">
            <p className="text-sm font-semibold text-slate-200 mb-2">📱 iPhone — Safari</p>
            <ol className="space-y-1 text-sm text-slate-400 list-decimal list-inside">
              <li>Open Safari and go to <span className="text-violet-400 font-mono text-xs">usestash.vercel.app</span></li>
              <li>Tap the Share button (box with arrow, bottom of screen)</li>
              <li>Scroll down and tap &ldquo;Add to Home Screen&rdquo;</li>
              <li>Tap <strong className="text-slate-300">Add</strong> in the top right corner</li>
            </ol>
          </div>
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-4">
            <p className="text-sm font-semibold text-slate-200 mb-2">🤖 Android — Chrome</p>
            <ol className="space-y-1 text-sm text-slate-400 list-decimal list-inside">
              <li>Open Chrome and go to <span className="text-violet-400 font-mono text-xs">usestash.vercel.app</span></li>
      ...
      {/* Voice Search */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">4. Using Voice Search</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-3">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 mb-4 space-y-2">
          {[
            ...
            <p key={i} className="text-sm text-slate-400 font-mono">{ex}</p>
          ))}
        </div>
        <p className="text-slate-500 text-xs px-1">💡 Speak clearly and naturally. You don&apos;t need to say exact titles — Stash understands context and partial descriptions.</p>
      ...
      {/* Music Service */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">5. Choosing Your Music Service</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-3">
        ...
        <p className="text-slate-500 text-xs mt-2 px-1">Your choice is saved automatically — you only need to set it once.</p>
      </section>

      {/* Saving Memories */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">6. Saving Memories</h2>
      ...
      {/* Tips */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">7. Tips for the Best Experience</h2>
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="bg-slate-900 border border-slate-800 rounded-xl p-4">
              <p className="text-sm font-semibold text-slate-200 mb-1">💡 {tip}</p>
      ...
      {/* Siri Shortcut */}
      <section className="mb-8">
        <h2 className="text-lg font-bold text-violet-400 mb-3 border-b border-slate-800 pb-2">Using Stash with Siri</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-4">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4">
          <p className="text-sm font-semibold text-slate-200 mb-2">Setting up a Siri Shortcut (iPhone)</p>
          <ol className="space-y-1 text-sm text-slate-400 list-decimal list-inside">
            <li>Open the Shortcuts app on your iPhone</li>
            <li>Tap <strong className="text-slate-300">+</strong> in the top right to create a new shortcut</li>
            <li>Tap Add Action, search for <strong className="text-slate-300">&ldquo;Open URL&rdquo;</strong> and select it</li>
            <li>Enter <span className="text-violet-400 font-mono text-xs">usestash.vercel.app</span> in the URL field</li>
            <li>Rename it to something easy to say, like <strong className="text-slate-300">&ldquo;Open Stash&rdquo;</strong></li>
            <li>Tap Done — now say &ldquo;Hey Siri, Open Stash&rdquo;</li>
          </ol>
        </div>
        <p className="text-slate-500 text-xs mt-2 px-1">Tip: Make sure Stash is added to your Home Screen first — the shortcut will then open the full-screen version.</p>
      </section>

      {/* Footer */}
      <div className="border-t border-slate-800 pt-6 text-center text-slate-500 text-xs space-y-1">
        <p>Questions or feedback? Use the 💬 Feedback button inside the app.</p>
        <p className="text-slate-700">usestash.vercel.app</p>
      </div>
